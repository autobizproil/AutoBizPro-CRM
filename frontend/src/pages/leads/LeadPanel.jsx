                ...
                <div className="flex items-stretch border-b border-gray-100 dark:border-gray-700 overflow-x-auto">
                  {canEdit && (
                    <button type="button" onClick={() => navigate('/settings?tab=stages')} title="הגדרת שלבי פייפליין"
                      className="flex-shrink-0 flex items-center justify-center px-3 bg-gray-50 dark:bg-gray-700/60 text-gray-500 hover:text-[#2398c2] dark:text-gray-300 dark:hover:text-[#2398c2] border-l border-gray-100 dark:border-gray-700 transition-colors">
