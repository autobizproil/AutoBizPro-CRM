...
const DEFAULT_VISIBLE = { name: true, phone: true, email: true, stage: true, status: true, source: true, assigned_to: false, created_at: true }
...
export default function LeadsPage() {
  ...
  return (
    <div className="flex h-full gap-0" dir="rtl">
      ...
      <aside className="w-48 flex-shrink-0 border-l border-gray-200 bg-white flex flex-col">
        <div className="px-4 py-3 border-b border-gray-100">
          <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">תצוגות שמורות</span>
        </div>
