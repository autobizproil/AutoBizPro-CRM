...
class ClientController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        // Whitelisted date columns a drill-down's date_field may target (matches EntityDescriptor's client dateFields)
        ...
        $filterFields = ['name', 'phone', 'email', 'company', 'source', 'assigned_to', 'created_at'];
